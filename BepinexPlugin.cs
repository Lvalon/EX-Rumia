...
{
	[BepInPlugin(lvalonexrumia.PInfo.GUID, lvalonexrumia.PInfo.Name, lvalonexrumia.PInfo.version)]
	...
	public class BepinexPlugin : BaseUnityPlugin
	{
		...
		//Custom: Will load DirResource/lvalonexrumiamodel.png 
		...
		public static List<ManaColor> offColors = new List<ManaColor>() { ManaColor.Colorless, ManaColor.White, ManaColor.Blue, ManaColor.Green };
		...
		public static CustomConfigEntry<bool> enableAct1BossEntry = new CustomConfigEntry<bool>(
			...
			section: "Act 1 Boss",
			key: "EnableAct1Boss",
			description: "Act 1 Boss");

		private static readonly Harmony harmony = lvalonexrumia.PInfo.harmony;
		...
		internal static DirectorySource directorySource = new DirectorySource(lvalonexrumia.PInfo.GUID, "");
		...
		private void Awake()
		{
			...
			EnemyUnitTemplate.AddBossNodeIcon(nameof(lvalonexrumia.Enemies.lvalonexrumia), getSprite);
		}
