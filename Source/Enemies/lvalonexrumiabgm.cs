...
namespace lvalonexrumia.Enemies
{
	public sealed class lvalonexrumiabgm : BgmTemplate
	{
		...
		public override IdContainer GetId() => nameof(lvalonexrumiabgm);
		public override UniTask<AudioClip> LoadAudioClipAsync()
		{
			return ResourceLoader.LoadAudioClip("lvalonexrumiabgm.ogg", (AudioType)14, BepinexPlugin.directorySource, "file://");
		}
