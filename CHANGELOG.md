...
- Run history's character icon going over the frame.
...
- Card balancing.
- Blood Clot limit reverted back to 50%.

### 新增 / Added

- 卡牌的条件性效果达成时会有显示。

- Cards with conditional effects satisfied will be highlighted.
...
[1.0.6]: https://thunderstore.io/package/download/Lvalon/EX_Rumia/1.0.6/
[1.0.5]: https://thunderstore.io/package/download/Lvalon/EX_Rumia/1.0.5/
